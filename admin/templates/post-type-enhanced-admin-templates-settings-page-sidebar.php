 ...
 * @Last Modified time: 2017-10-20 17:43:48
 */
...
<div class="postbox">
	...
	<div class="inside">
		...
		<ul>
			...
			<li class="version">
				<span class="dashicons dashicons-admin-plugins"></span> <?php echo esc_html_x( 'Name', 'Name of the plugin', 'post-type-enhanced' ); ?> 
				<?php echo ( self::get_plugin_data('Title') ); ?>
			</li>	

			<li class="version">
				<span class="dashicons dashicons-admin-generic"></span> <?php echo esc_html_x( 'Version', 'Plugin version', 'post-type-enhanced' ); ?> 
